...
public class BootstrapperConstants {
	...
	public static final String TUTORIAL = "Basic Instructions to use this application: \n First, know the name of the room or other location you want to be your starting point and the name of the room or\n other location you want to be your destination. Our application knows several common synonyms for each room,\n such as 'Atwater Kent 106' for 'AK 106'. \nIn the search box at the top right labeled 'Starting point', start to type the name of your starting point. The application will suggest possible locations to you. As you type more, the suggestions will become closer to your goal.\n Once your desired starting point is suggested by the application, select it by left clicking on it in the dropdown list. Do the same for your desired destination in the search box labeled 'Destination',\n immediately below the dropdown for starting point. \nOnce you have entered your desired start and destination, hit 'search'. The application will generate a route for you, and take you to the start location. \nYou can look at the path drawn on the map or at the directions list on the left. Hit the 'next map' button to be shown the next portion of the path if your path moves between maps";
